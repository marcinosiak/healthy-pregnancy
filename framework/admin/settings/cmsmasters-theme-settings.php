...
add_action('admin_menu', 'healthy_pregnancy_add_menu');
add_action('admin_init', 'healthy_pregnancy_register_settings');
...
function healthy_pregnancy_get_settings() {
	$output = array();
	
	
	$page = healthy_pregnancy_get_admin_page();
	...
	case 'cmsmasters-settings':
		$cmsmasters_option_name = 'cmsmasters_options_' . 'healthy-pregnancy';
		$cmsmasters_settings_page_title = esc_html__('Theme General Settings', 'healthy-pregnancy');
		$cmsmasters_page_sections = apply_filters('cmsmasters_options_general_sections_filter', healthy_pregnancy_options_general_sections(), $tab);
		$cmsmasters_page_fields = apply_filters('cmsmasters_options_general_fields_filter', healthy_pregnancy_options_general_fields(), $tab);
		$cmsmasters_page_tabs = apply_filters('cmsmasters_options_general_tabs_filter', healthy_pregnancy_options_general_tabs());
	...
	case 'cmsmasters-settings' . '-font':
		$cmsmasters_option_name = 'cmsmasters_options_' . 'healthy-pregnancy' . '_font';
		$cmsmasters_settings_page_title = esc_html__('Theme Fonts Settings', 'healthy-pregnancy');
		$cmsmasters_page_sections = apply_filters('cmsmasters_options_font_sections_filter', healthy_pregnancy_options_font_sections(), $tab);
		$cmsmasters_page_fields = apply_filters('cmsmasters_options_font_fields_filter', healthy_pregnancy_options_font_fields(), $tab);
		$cmsmasters_page_tabs = apply_filters('cmsmasters_options_font_tabs_filter', healthy_pregnancy_options_font_tabs());
	...
	case 'cmsmasters-settings' . '-color':
		$cmsmasters_option_name = 'cmsmasters_options_' . 'healthy-pregnancy' . '_color';
		$cmsmasters_settings_page_title = esc_html__('Theme Color Schemes', 'healthy-pregnancy');
		$cmsmasters_page_sections = healthy_pregnancy_options_color_sections();
		$cmsmasters_page_fields = apply_filters('cmsmasters_options_color_fields_filter', healthy_pregnancy_options_color_fields(), $tab);
		$cmsmasters_page_tabs = healthy_pregnancy_options_color_tabs();
	...
	case 'cmsmasters-settings' . '-element':
		$cmsmasters_option_name = 'cmsmasters_options_' . 'healthy-pregnancy' . '_element';
		$cmsmasters_settings_page_title = esc_html__('Theme Elements Settings', 'healthy-pregnancy');
		$cmsmasters_page_sections = apply_filters('cmsmasters_options_element_sections_filter', healthy_pregnancy_options_element_sections(), $tab);
		$cmsmasters_page_fields = apply_filters('cmsmasters_options_element_fields_filter', healthy_pregnancy_options_element_fields(), $tab);
		$cmsmasters_page_tabs = apply_filters('cmsmasters_options_element_tabs_filter', healthy_pregnancy_options_element_tabs());
	...
	case 'cmsmasters-settings' . '-single':
		$cmsmasters_option_name = 'cmsmasters_options_' . 'healthy-pregnancy' . '_single';
		$cmsmasters_settings_page_title = esc_html__('Theme Single Posts Settings', 'healthy-pregnancy');
		$cmsmasters_page_sections = apply_filters('cmsmasters_options_single_sections_filter', healthy_pregnancy_options_single_sections(), $tab);
		$cmsmasters_page_fields = apply_filters('cmsmasters_options_single_fields_filter', healthy_pregnancy_options_single_fields(), $tab);
		$cmsmasters_page_tabs = apply_filters('cmsmasters_options_single_tabs_filter', healthy_pregnancy_options_single_tabs());
	...
	case 'cmsmasters-settings' . '-demo':
		$cmsmasters_option_name = 'cmsmasters_options_' . 'healthy-pregnancy' . '_demo';
		$cmsmasters_settings_page_title = esc_html__('Theme Settings Import/Export', 'healthy-pregnancy');
		$cmsmasters_page_sections = healthy_pregnancy_options_demo_sections();
		$cmsmasters_page_fields = healthy_pregnancy_options_demo_fields();
		$cmsmasters_page_tabs = healthy_pregnancy_options_demo_tabs();
...
function healthy_pregnancy_create_settings_field($args = array()) {
	$defaults = array( 
		'id' => 		'default_field', 
		'title' => 		esc_html__('Default Field', 'healthy-pregnancy'), 
		'desc' => 		esc_html__('This is a default description.', 'healthy-pregnancy'), 
		'std' => 		'', 
		'type' => 		'text', 
	...
	add_settings_field( 
		esc_attr($id), 
		esc_html($title), 
		'healthy_pregnancy_form_field_fn', 
		__FILE__, 
		$section, 
		$field_args 
	);
...
function healthy_pregnancy_register_settings() {
	$settings_output = healthy_pregnancy_get_settings();
	...
	register_setting($cmsmasters_option_name, $cmsmasters_option_name, 'healthy_pregnancy_validate_options');
	
	
	if (!empty($settings_output['cmsmasters_page_sections'])) {
		foreach ($settings_output['cmsmasters_page_sections'] as $id => $title) {
			add_settings_section($id, $title, 'healthy_pregnancy_section_fn', __FILE__);
		}
	}
	...
	if (!empty($settings_output['cmsmasters_page_fields'])) {
		foreach ($settings_output['cmsmasters_page_fields'] as $option) {
			healthy_pregnancy_create_settings_field($option);
		}
	}
...
function healthy_pregnancy_settings_scripts() {
	wp_enqueue_style('wp-jquery-ui-dialog');
	
	
	wp_enqueue_style('healthy-pregnancy-settings-css', get_template_directory_uri() . '/framework/admin/settings/css/cmsmasters-theme-settings.css', array(), '1.0.0', 'screen');
	
	
	if (is_rtl()) {
		wp_enqueue_style('healthy-pregnancy-settings-css-rtl', get_template_directory_uri() . '/framework/admin/settings/css/cmsmasters-theme-settings-rtl.css', array(), '1.0.0', 'screen');
	}
	...
	wp_enqueue_script('healthy-pregnancy-settings-js', get_template_directory_uri() . '/framework/admin/settings/js/cmsmasters-theme-settings.js', array('jquery', 'farbtastic'), '1.0.0', true);
	
	wp_localize_script('healthy-pregnancy-settings-js', 'cmsmasters_setting', array( 
		'palettes' => 			implode(',', cmsmasters_color_picker_palettes()), 
		'remove' => 			esc_attr__('Remove', 'healthy-pregnancy'), 
		'remove_sidebar' => 	esc_html__('Do you realy want to remove this sidebar?', 'healthy-pregnancy'), 
		'find' => 				esc_attr__('Find icons', 'healthy-pregnancy'), 
		'remove_icon' => 		esc_html__('Do you realy want to remove this social icon?', 'healthy-pregnancy'), 
		'theme_uri' => 			get_template_directory_uri(), 
		'shortname' => 			'healthy-pregnancy', 
		'done' => 				esc_html__('All theme settings were imported successfully.', 'healthy-pregnancy'), 
		'fail' => 				esc_html__("Error on page!!!\nPlease reload page and try again.", 'healthy-pregnancy'), 
	...
	wp_enqueue_script('healthy-pregnancy-settings-js-toggle', get_template_directory_uri() . '/framework/admin/settings/js/cmsmasters-theme-settings-toggle.js', array('jquery'), '1.0.0', true);
	
	wp_localize_script('healthy-pregnancy-settings-js-toggle', 'cmsmasters_settings', array( 
		'shortname' => 	'healthy-pregnancy' 
	));
...
function healthy_pregnancy_add_menu() {
	$settings_output = healthy_pregnancy_get_settings();
	...
	$add_menu_p( 
		esc_attr__('Theme Settings', 'healthy-pregnancy'), 
		esc_attr__('Theme Settings', 'healthy-pregnancy'), 
		'manage_options', 
		'cmsmasters-settings', 
		'healthy_pregnancy_settings_page_fn', 
		'' 
	);
	...
	$cmsmasters_settings_general = $add_submenu_p( 
		'cmsmasters-settings', 
		esc_attr__('Theme General Settings', 'healthy-pregnancy'), 
		esc_attr__('General', 'healthy-pregnancy'), 
		'manage_options', 
		'cmsmasters-settings', 
		'healthy_pregnancy_settings_page_fn' 
	);
	
	add_action('load-' . $cmsmasters_settings_general, 'healthy_pregnancy_settings_scripts');
	
	
	$cmsmasters_settings_font = $add_submenu_p( 
		'cmsmasters-settings', 
		esc_attr__('Theme Fonts Settings', 'healthy-pregnancy'), 
		esc_attr__('Fonts', 'healthy-pregnancy'), 
		'manage_options', 
		'cmsmasters-settings' . '-font', 
		'healthy_pregnancy_settings_page_fn' 
	);
	
	add_action('load-' . $cmsmasters_settings_font, 'healthy_pregnancy_settings_scripts');
	
	
	$cmsmasters_settings_color = $add_submenu_p( 
		'cmsmasters-settings', 
		esc_attr__('Theme Color Schemes', 'healthy-pregnancy'), 
		esc_attr__('Colors', 'healthy-pregnancy'), 
		'manage_options', 
		'cmsmasters-settings' . '-color', 
		'healthy_pregnancy_settings_page_fn' 
	);
	
	add_action('load-' . $cmsmasters_settings_color, 'healthy_pregnancy_settings_scripts');
	
	
	$cmsmasters_settings_element = $add_submenu_p( 
		'cmsmasters-settings', 
		esc_attr__('Theme Elements Settings', 'healthy-pregnancy'), 
		esc_attr__('Elements', 'healthy-pregnancy'), 
		'manage_options', 
		'cmsmasters-settings' . '-element', 
		'healthy_pregnancy_settings_page_fn' 
	);
	
	add_action('load-' . $cmsmasters_settings_element, 'healthy_pregnancy_settings_scripts');
	
	
	$cmsmasters_settings_single = $add_submenu_p( 
		'cmsmasters-settings', 
		esc_attr__('Theme Single Posts Settings', 'healthy-pregnancy'), 
		esc_attr__('Single Posts', 'healthy-pregnancy'), 
		'manage_options', 
		'cmsmasters-settings' . '-single', 
		'healthy_pregnancy_settings_page_fn' 
	);
	
	add_action('load-' . $cmsmasters_settings_single, 'healthy_pregnancy_settings_scripts');
	
	
	$cmsmasters_settings_demo = $add_submenu_p( 
		'cmsmasters-settings', 
		esc_attr__('Theme Settings Import/Export', 'healthy-pregnancy'), 
		esc_attr__('Import/Export', 'healthy-pregnancy'), 
		'manage_options', 
		'cmsmasters-settings' . '-demo', 
		'healthy_pregnancy_settings_page_fn' 
	);
	
	add_action('load-' . $cmsmasters_settings_demo, 'healthy_pregnancy_settings_scripts');
}


function healthy_pregnancy_section_fn($desc) {
	$tab = healthy_pregnancy_get_the_tab();
...
function healthy_pregnancy_settings_page_fn() {
	$settings_output = healthy_pregnancy_get_settings();
	$current_tab = healthy_pregnancy_get_the_tab();
	
	echo '<div class="wrap">';
	
	healthy_pregnancy_settings_page_header();
	...
	if ($current_tab != 'wpml') {
		...
		'<p class="submit-top">' . 
			(($current_tab != 'import' && $current_tab != 'export') ? '<input name="submit-top" type="submit" class="button button-primary button-large" value="' . esc_attr__('Save Changes', 'healthy-pregnancy') . '" />' : '') . 
		'</p>';
		...
		echo '<p class="submit">' . 
				(($current_tab != 'import' && $current_tab != 'export') ? '<input name="submit" type="submit" class="button button-primary button-large" value="' . esc_attr__('Save Changes', 'healthy-pregnancy') . '" />' : (($current_tab == 'import') ? '<input name="import" type="button" class="button button-primary button-large cmsmasters-demo-import" value="' . esc_attr__('Import Settings', 'healthy-pregnancy') . '" />' : '')) . 
			'</p>' . 
		'</form>';
	} else {
		do_settings_sections(__FILE__);
...
function healthy_pregnancy_form_field_fn($args = array()) {
	extract($args);
	...
	case 'upload':
		...
		echo '<div class="cmsmasters_upload_parent cmsmasters_select_parent">' . 
			'<input type="button" id="cmsmasters_upload_' . $id . '_button" class="cmsmasters_upload_button button button-large" value="' . esc_attr__('Choose Image', 'healthy-pregnancy') . '" data-title="' . esc_attr__('Choose Image', 'healthy-pregnancy') . '" data-button="' . esc_attr__('Insert Image', 'healthy-pregnancy') . '" data-id="cmsmasters-media-select-frame-' . $id . '" data-classes="media-frame cmsmasters-media-select-frame' . ((!isset($description)) ? ' cmsmasters-frame-no-description' : '') . ((!isset($caption)) ? ' cmsmasters-frame-no-caption' : '') . ((!isset($align)) ? ' cmsmasters-frame-no-align' : '') . ((!isset($link)) ? ' cmsmasters-frame-no-link' : '') . ((!isset($size)) ? ' cmsmasters-frame-no-size' : '') . '" data-library="image" data-type="' . $frame . '"' . (($frame == 'post') ? ' data-state="insert"' : '') . ' data-multiple="' . $multiple . '" />' . 
			'<div class="cmsmasters_upload"' . (($image != '') ? ' style="display:block;"' : '') . '>' . 
				'<img src="' . (($image != '') ? $image : '') . '" class="cmsmasters_preview_image" alt="" />' . 
				'<a href="#" class="cmsmasters_upload_cancel admin-icon-remove" title="' . esc_attr__('Remove', 'healthy-pregnancy') . '"></a>' . 
			'</div>' . 
	...
	case 'typorgaphy':
		...
		if ($system_font) {
			echo '<div class="cmsmasters_admin_block">' . 
				...
				foreach (healthy_pregnancy_system_fonts_list() as $key => $value) {
					echo '<option value="' . esc_attr($key) . '"' . (($options[$id . '_system_font'] == $key) ? ' selected="selected"' : '') . '>' . esc_html($value) .'</option>';
				}
				
				echo '</select>' . 
				' &nbsp; ' . 
				'<label for="' . $id . '_system_font">' . esc_html__('System Font', 'healthy-pregnancy') . '</label>' . 
			'</div>';
		}
		...
		if ($google_font) {
			echo '<div class="cmsmasters_admin_block">' . 
				...
				echo '</select>' . 
				' &nbsp; ' . 
				'<label for="' . $id . '_google_font">' . esc_html__('Google Font', 'healthy-pregnancy') . '</label>' . 
			'</div>';
		}
		...
		if ($font_size) {
			echo '<div class="cmsmasters_admin_block">' . 
				...
				' &nbsp; ' . 
				'<label for="' . $id . '_font_size_number">' . esc_html__('Font Size', 'healthy-pregnancy') . ' <em>(' . esc_html__('in pixels', 'healthy-pregnancy') . ')</em></label>' . 
			'</div>';
		}
		...
		if ($line_height) {
			echo '<div class="cmsmasters_admin_block">' . 
				...
				' &nbsp; ' . 
				'<label for="' . $id . '_line_height_number">' . esc_html__('Line Height', 'healthy-pregnancy') . ' <em>(' . esc_html__('in pixels', 'healthy-pregnancy') . ')</em></label>' . 
			'</div>';
		}
		...
		if ($font_weight) {
			echo '<div class="cmsmasters_admin_block">' . 
				...
				echo '</select>' . 
				' &nbsp; ' . 
				'<label for="' . $id . '_font_weight">' . esc_html__('Font Weight', 'healthy-pregnancy') . '</label>' . 
			'</div>';
		}
		...
		if ($font_style) {
			echo '<div class="cmsmasters_admin_block">' . 
				...
				echo '</select>' . 
				' &nbsp; ' . 
				'<label for="' . $id . '_font_style">' . esc_html__('Font Style', 'healthy-pregnancy') . '</label>' . 
			'</div>';
		}
		...
		if ($text_transform) {
			echo '<div class="cmsmasters_admin_block">' . 
				...
				foreach (healthy_pregnancy_text_transform_list() as $key => $value) {
					echo '<option value="' . esc_attr($key) . '"' . (($options[$id . '_text_transform'] == $key) ? ' selected="selected"' : '') . '>' . esc_html($value) .'</option>';
				}
				
				echo '</select>' . 
				' &nbsp; ' . 
				'<label for="' . $id . '_text_transform">' . esc_html__('Text Transform', 'healthy-pregnancy') . '</label>' . 
			'</div>';
		}
		...
		if ($text_decoration) {
			echo '<div class="cmsmasters_admin_block">' . 
				...
				foreach (healthy_pregnancy_text_decoration_list() as $key => $value) {
					echo '<option value="' . esc_attr($key) . '"' . (($options[$id . '_text_decoration'] == $key) ? ' selected="selected"' : '') . '>' . esc_html($value) .'</option>';
				}
				
				echo '</select>' . 
				' &nbsp; ' . 
				'<label for="' . $id . '_text_decoration">' . esc_html__('Text Decoration', 'healthy-pregnancy') . '</label>' . 
			'</div>';
		}
	...
	case 'sidebar':
		...
		'<div class="sidebar_management">' . 
			'<p>' . 
				...
				'<input class="button" type="button" id="add_sidebar" value="' . esc_attr__('Add Sidebar', 'healthy-pregnancy') . '" />' . 
			'</p>' . 
			'<div></div>' . 
			'<ul>';
	...
	case 'social':
		...
		'<div class="icon_management">' . 
			'<p>' . 
				...
				'<input id="' . $id . '_button" class="cmsmasters_icon_choose_button button" type="button" value="' . esc_attr__('Choose icon', 'healthy-pregnancy') . '" />' . 
				'<a href="#" class="cmsmasters_remove_icon admin-icon-remove" title="' . esc_attr__('Cancel changes', 'healthy-pregnancy') . '"></a>' . 
			'</p>' . 
			'<span class="cl"><br /></span>' . 
			'<span class="icon_upload_link" style="display:none;">' . 
				'<label for="new_icon_color">' . 
					'<span class="cmsmasters_col_label">' . esc_html__('Icon Color', 'healthy-pregnancy') . '</span>' . 
				...
				'<label for="new_icon_hover">' . 
					'<span class="cmsmasters_col_label">' . esc_html__('Icon Hover Color', 'healthy-pregnancy') . '<br /><em>' . esc_html__('if not selected - Icon Color will be used', 'healthy-pregnancy') . '</em></span>' . 
				...
				'<label for="new_icon_link">' . 
					...
					esc_html__('Icon Link', 'healthy-pregnancy') . 
				'</label>' . 
				'<label for="new_icon_title">' . 
					'<input class="all-options" type="text" id="new_icon_title" /> ' . 
					esc_html__('Icon Title', 'healthy-pregnancy') . 
				'</label>' . 
				'<label for="new_icon_target">' . 
					'<input type="checkbox" id="new_icon_target" value="true" /> ' . 
					esc_html__('Open link in a new tab/window?', 'healthy-pregnancy') . 
				'</label>' . 
			'</span>' . 
			'<span class="cl"></span>' . 
			'<input class="button button-primary" type="button" id="add_icon" value="' . esc_attr__('Add Icon', 'healthy-pregnancy') . '" />' . 
			'<input class="button button-primary" type="button" id="edit_icon" value="' . esc_attr__('Save Icon', 'healthy-pregnancy') . '" />' . 
			'<ul>';
			...
			if (isset($options[$id]) && is_array($options[$id])) {
				foreach($options[$id] as $icon) {
					...
					echo '<li>' . 
						...
						'</div>' . 
						'<a href="#" class="icon_del admin-icon-remove" title="' . esc_attr__('Remove', 'healthy-pregnancy') . '"></a> ' . 
...
function healthy_pregnancy_validate_options($input) {
	$valid_input = array();
	...
	foreach ($options as $option) {
		...
		case 'text':
			...
			case 'numeric':
				...
				$valid_input[$option['id']] = (is_numeric($input[$option['id']])) ? $input[$option['id']] : esc_html__('Expecting a Numeric value!', 'healthy-pregnancy');
				
				if (is_numeric($input[$option['id']]) == false) {
					add_settings_error(
						$option['id'],
						'healthy-pregnancy' . '_txt_numeric_error',
						esc_html__('Expecting a Numeric value! Please fix.', 'healthy-pregnancy'),
						'error'
					);
				}
			...
			case 'multinumeric':
				...
				if ($input[$option['id']] != '') {
					$valid_input[$option['id']] = (preg_match('/^-?\d+(?:,\s?-?\d+)*$/', $input[$option['id']]) == 1) ? $input[$option['id']] : esc_html__('Expecting comma separated numeric values', 'healthy-pregnancy');
				} else {
				...
				if ($input[$option['id']] != '' && preg_match('/^-?\d+(?:,\s?-?\d+)*$/', $input[$option['id']]) != 1) {
					add_settings_error(
						$option['id'],
						'healthy-pregnancy' . '_txt_multinumeric_error',
						esc_html__('Expecting comma separated numeric values! Please fix.','healthy-pregnancy'),
						'error'
					);
				}
			...
			case 'email':
				...
				if ($input[$option['id']] != '') {
					$valid_input[$option['id']] = (is_email($input[$option['id']]) !== false) ? $input[$option['id']] : esc_html__('Invalid email! Please re-enter!', 'healthy-pregnancy');
				} elseif ($input[$option['id']] == '') {
					$valid_input[$option['id']] = esc_html__('This setting field cannot be empty! Please enter a valid email address.', 'healthy-pregnancy');
				}
				
				if (is_email($input[$option['id']]) == false || $input[$option['id']] == '') {
					add_settings_error(
						$option['id'],
						'healthy-pregnancy' . '_txt_email_error',
						esc_html__('Please enter a valid email address.', 'healthy-pregnancy'),
						'error'
					);
				}
		...
		case 'number':
			$input[$option['id']] = trim($input[$option['id']]);
			$valid_input[$option['id']] = (is_numeric($input[$option['id']])) ? $input[$option['id']] : esc_html__('Number!', 'healthy-pregnancy');
...
function healthy_pregnancy_show_msg($message, $msgclass = 'info') {
	echo '<div id="message" class="' . $msgclass . '">' . $message . '</div>';
}


function healthy_pregnancy_admin_msgs() {
	global $pagenow;
	...
	if ($pagenow == 'admin.php' && current_user_can('manage_options') && $cmsmasters_settings_pg !== false && !empty($set_errors)) {
		if ($set_errors[0]['code'] == 'settings_updated' && isset($_GET['settings-updated'])) {
			healthy_pregnancy_show_msg('<p><strong>' . $set_errors[0]['message'] . '</strong></p>', 'updated');
		} else {
			foreach ($set_errors as $set_error) {
				healthy_pregnancy_show_msg('<p class="setting-error-message" title="' . esc_attr($set_error['setting']) . '">' . $set_error['message'] . '</p>', 'error');
			}
		}
	}
}

add_action('admin_notices', 'healthy_pregnancy_admin_msgs');


function healthy_pregnancy_add_global_options() {
	$cmsmasters_option_names = array( 
		array( 
			'cmsmasters_options_' . 'healthy-pregnancy' . '_general', 
			healthy_pregnancy_options_general_fields('general') 
		), 
		array( 
			'cmsmasters_options_' . 'healthy-pregnancy' . '_bg', 
			healthy_pregnancy_options_general_fields('bg') 
		), 
		array( 
			'cmsmasters_options_' . 'healthy-pregnancy' . '_header', 
			healthy_pregnancy_options_general_fields('header') 
		), 
		array( 
			'cmsmasters_options_' . 'healthy-pregnancy' . '_content', 
			healthy_pregnancy_options_general_fields('content') 
		), 
		array( 
			'cmsmasters_options_' . 'healthy-pregnancy' . '_footer', 
			healthy_pregnancy_options_general_fields('footer') 
		), 
		array( 
			'cmsmasters_options_' . 'healthy-pregnancy' . '_font_content', 
			healthy_pregnancy_options_font_fields('content') 
		), 
		array( 
			'cmsmasters_options_' . 'healthy-pregnancy' . '_font_link', 
			healthy_pregnancy_options_font_fields('link') 
		), 
		array( 
			'cmsmasters_options_' . 'healthy-pregnancy' . '_font_nav', 
			healthy_pregnancy_options_font_fields('nav') 
		), 
		array( 
			'cmsmasters_options_' . 'healthy-pregnancy' . '_font_heading', 
			healthy_pregnancy_options_font_fields('heading') 
		), 
		array( 
			'cmsmasters_options_' . 'healthy-pregnancy' . '_font_other', 
			healthy_pregnancy_options_font_fields('other') 
		), 
		array( 
			'cmsmasters_options_' . 'healthy-pregnancy' . '_element_sidebar', 
			healthy_pregnancy_options_element_fields('sidebar') 
		), 
		array( 
			'cmsmasters_options_' . 'healthy-pregnancy' . '_element_icon', 
			healthy_pregnancy_options_element_fields('icon') 
		), 
		array( 
			'cmsmasters_options_' . 'healthy-pregnancy' . '_element_lightbox', 
			healthy_pregnancy_options_element_fields('lightbox') 
		), 
		array( 
			'cmsmasters_options_' . 'healthy-pregnancy' . '_element_sitemap', 
			healthy_pregnancy_options_element_fields('sitemap') 
		), 
		array( 
			'cmsmasters_options_' . 'healthy-pregnancy' . '_element_error', 
			healthy_pregnancy_options_element_fields('error') 
		), 
		array( 
			'cmsmasters_options_' . 'healthy-pregnancy' . '_element_code', 
			healthy_pregnancy_options_element_fields('code') 
		), 
		array( 
		...
		array( 
			...
			healthy_pregnancy_options_single_fields('post') 
		), 
		array( 
			'cmsmasters_options_' . 'healthy-pregnancy' . '_single_project', 
			healthy_pregnancy_options_single_fields('project') 
		), 
		array( 
			'cmsmasters_options_' . 'healthy-pregnancy' . '_single_profile', 
			healthy_pregnancy_options_single_fields('profile') 
		), 
		array( 
			'cmsmasters_options_' . 'healthy-pregnancy' . '_single_campaign', 
			healthy_pregnancy_options_single_fields('campaign') 
		) 
	);
	...
	foreach (healthy_pregnancy_all_color_schemes_list() as $key => $value) {
		array_push($cmsmasters_option_names, array( 
			'cmsmasters_options_' . 'healthy-pregnancy' . '_color_' . $key, 
			healthy_pregnancy_options_color_fields($key) 
		));
	}
		...
		if ($cmsmasters_option_name[1] !== '') {
			foreach ($cmsmasters_option_name[1] as $selected_option) {
				if ( 
					...
					$selected_option['id'] !== 'healthy-pregnancy' . '_social_icons' 
				) {
...
function healthy_pregnancy_get_global_options() {
	...
	foreach (healthy_pregnancy_all_color_schemes_list() as $key => $value) {
		array_push($cmsmasters_option_names, 'cmsmasters_options_' . 'healthy-pregnancy' . '_color_' . $key);
	}
