...
function healthy_pregnancy_get_admin_page() {
	global $pagenow;
...
function healthy_pregnancy_default_tab() {
	$current_page = healthy_pregnancy_get_admin_page();
...
function healthy_pregnancy_get_the_tab() {
	global $pagenow;
	
	$default_tab = healthy_pregnancy_default_tab();
...
function healthy_pregnancy_settings_page_header() {
